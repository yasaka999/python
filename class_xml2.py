...
class MediaObject(object):
    def __init__(self, name, code, url, programcode, mediaspec, type, screenformat):
        self.name = name
        self.code = code
        self.url = url
        self.programcode = programcode
        self.mediaspec = mediaspec
        self.type = type
        self.screenformat = screenformat

    def object_deal(self):
        object_xml = ET.SubElement(objects, "Object")
        object_xml.set("Type", "Movie")
        object_xml.set("Name", self.name)
        object_xml.set("Code", self.code)
        object_xml.set("URL", self.url)
        object_xml.set("ProgramCode", self.programcode)
        object_xml.set("MediaSpec", self.mediaspec)
        object_xml.set("Type", self.type)
        object_xml.set("ScreenFormat", self.screenformat)