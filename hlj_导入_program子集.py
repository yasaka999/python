...
if __name__ == '__main__':
    file = open("../files/hlj_program_series.txt", "w")
    with open("../files/hlj_series_program.txt", encoding='utf8') as f:
        list1 = f.read().split("\n")
    for i in range(len(list1)):
        scode = list1[i].split("|")[0]
        name = list1[i].split("|")[1]
        print (list1[i],'HLJDEMO000000'+str(10000+i),sep=',')
        code = 'HLJDEMO000000'+str(10000+i)
