<template>
  <div>
    ...
    <div v-for="ms in milestones" :key="ms.id" class="page-card" style="margin-bottom:12px">
      <div class="ms-header">
        <div style="display:flex;align-items:center;gap:10px">
          ...
          <span style="color:#999;font-size:13px">计划: {{ ms.plan_date || '-' }}  实际: {{ ms.actual_date || '-' }}</span>
        </div>
        <div>
      ...
      <el-table :data="tasksByMs(ms.id)" size="small" style="width:100%;margin-top:10px">
    ...
    <!-- 里程碑对话框 -->
    <el-dialog v-model="msDlg" :title="editMsId ? '编辑里程碑' : '新建里程碑'" width="480px">
    ...
    <!-- 任务对话框 -->
    <el-dialog v-model="taskDlg" :title="editTaskId ? '编辑任务' : '新建任务'" width="560px">
