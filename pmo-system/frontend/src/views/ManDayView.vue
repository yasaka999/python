<template>
  <div>
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
      ...
      <div>
        <el-button @click="downloadMd" :loading="downloading"><el-icon><Download /></el-icon> 导出报表</el-button>
    ...
    <div class="page-card">
      ...
      <el-table :data="mandays" stripe border v-loading="loading">
    ...
    <el-dialog v-model="dlg" :title="editId ? '编辑人天记录' : '新建人天记录'" width="520px">
